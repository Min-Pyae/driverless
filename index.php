...
<head>
    ...
    <!-- BOOTSTRAP CSS -->
    <link rel="stylesheet" href="./vendor/bootstrap/css/bootstrap.min.css?v=<?php echo time(); ?>">
    <link rel="stylesheet" href="./vendor/bootstrap/icons/font/bootstrap-icons.css?v=<?php echo time(); ?>">
